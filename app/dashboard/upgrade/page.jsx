...
import PricingPlan from '@/app/dashboard/_data/PricingPlan'
...
export default function Upgrade() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    {PricingPlan.map((item,ind)=>(
      <div key={ind} className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
